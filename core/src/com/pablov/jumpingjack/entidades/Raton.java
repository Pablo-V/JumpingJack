...
public class Raton extends Enemigo {
    ...
    protected void definirEnemigo() {
        ...
        vertices[0] = new Vector2(-20, 17.5f).scl(1 / Juego.PPM);
        vertices[1] = new Vector2(20, 17.5f).scl(1 / Juego.PPM);
        vertices[2] = new Vector2(-20, 10).scl(1 / Juego.PPM);
        vertices[3] = new Vector2(20, 10).scl(1 / Juego.PPM);
        cabeza.set(vertices);
